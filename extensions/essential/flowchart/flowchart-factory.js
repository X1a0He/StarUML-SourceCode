...
function flowPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.FCModelElement &&
      options.headModel instanceof type.FCModelElement,
...
app.factory.registerModelAndViewFn("FCFlow", _directedRelationshipFn, {
...
app.factory.registerViewOfFn("FCFlowchartDiagram", viewForGeneralDiagramFn);
