  ...
  if (model instanceof type.UMLPort) {
    ...
    if (
      ...
      app.dialogs.showAlertDialog(
        "Port should be dropped on it's parent Classifier or Part",
      );
    }
    ...
    if (
      ...
      app.dialogs.showAlertDialog(
        "Part (Attribute) should be dropped on it's parent Classifier",
      );
    }
    ...
    if (connectorView) {
      ...
      app.dialogs.showAlertDialog(
        "Connector View is already existed in this Diagram.",
      );
    } else {
      if (!port2View) {
    ...
    if (assoClassLink && assoClassLink.classSide === model) {
      ...
      if (linkView) {
        ...
        app.dialogs.showAlertDialog(
          "AssociationClass View is already existed in this Diagram.",
        );
      } else {
        if (!classView) {
...
function viewForStatechartDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLConnectionPointReference) {
    if (
      ...
      app.dialogs.showAlertDialog(
        "ConnectionPointReference should be dropped on it's parent State",
      );
    }
...
function viewForActivityDiagramFn(model, diagram, options) {
  ...
  if (model instanceof type.UMLInputPin || model instanceof type.UMLOutputPin) {
    if (
      ...
      app.dialogs.showAlertDialog(
        "Pin should be dropped on it's parent Action",
      );
    }
