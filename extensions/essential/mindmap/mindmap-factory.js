...
function edgePrecondition (options) {
  app.factory.assert(
    (options.tailModel instanceof type.MMNode) && (options.headModel instanceof type.MMNode),
...
app.factory.registerModelAndViewFn('MMEdge', _directedRelationshipFn, { precondition: edgePrecondition })
